...
public class OrdinationTest
{
    ...
    public void DagligSkaev_DoegnDosis_BeregnesKorrekt()
    {
        ...
        dagligSkaev.opretDosis(Util.CreateTimeOnly(9, 30, 0), 2);
        dagligSkaev.opretDosis(Util.CreateTimeOnly(13, 30, 0), 1);
        dagligSkaev.opretDosis(Util.CreateTimeOnly(19, 30, 0), 3);
